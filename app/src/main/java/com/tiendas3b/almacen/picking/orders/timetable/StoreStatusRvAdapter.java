 ...
 */
public class StoreStatusRvAdapter extends BaseRecyclerViewAdapter<StorePickingStatus> implements RecyclerViewFastScroller.BubbleTextGetter {

//    private final List<StorePickingStatus> mValues;
//    private final OnListFragmentInteractionListener mListener;
    private final GlobalState mContext;

    public StoreStatusRvAdapter(GlobalState context /*, OnListFragmentInteractionListener listener*/) {
        super(context);
        mContext = context;
    }
...
//        View view = inflater.inflate(R.layout.row_epackage, viewGroup, false);
    ...
    @Override
    protected void bindView(StorePickingStatus item, ViewHolder viewHolder) {
        if (item != null) {
