...
public class DataBaseUtil {
    ...
    public static boolean insertLog(IDatabaseManager databaseManager, String description, Long tripId, Long regionId, Long userId, Long storeId, Long truckId, Long activityId) {
