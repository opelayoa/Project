...
public class EpackageDownloadStoresActivity extends RecyclerViewCalendarActivity {

    private static final String TAG = "ShipmentEpackageActivity";
    private StoresDownloadRecyclerViewAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        databaseManager = DatabaseManager.getInstance(EpackageDownloadStoresActivity.this);
        ...
        adapter = new StoresDownloadRecyclerViewAdapter(EpackageDownloadStoresActivity.this, databaseManager, DateUtil.getDateStr(selectedDate), new BaseRecyclerViewAdapter.OnViewHolderClick() {
            @Override
            public void onClick(View view, int position) {
                startActivity(new Intent(mContext, DownloadEpackageActivity.class).putExtra(DownloadEpackageActivity.EXTRA_STORE, (Serializable) items.get(position))
