 ...
 */
public class EpackageLeaveRvAdapter extends BaseRecyclerViewAdapter<EPackage> {
...
//        activity = context;
//    }
    public EpackageLeaveRvAdapter(Context context, EpackageListener listener) {
        super(context);
    ...
    protected View createView(Context context, ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(ctx).inflate(R.layout.row_epackage_leave, viewGroup, false);
