...
public class ReceiptTimetableTabsFragment extends Fragment {
    ...
    private void init(View rootView) {
        ...
        ReceiptStoresStatusPagerAdapter mSectionsPagerAdapter = new ReceiptStoresStatusPagerAdapter(getChildFragmentManager(), args.getInt(TYPE), args.getInt(DAY));
