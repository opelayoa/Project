 ...
 */
public class EpackageAutRvAdapter extends BaseRecyclerViewAdapter<EPackage> {
...
//    }
    ...
    public EpackageAutRvAdapter(Context context, EpackageListener listener) {
        super(context);
    ...
    protected View createView(Context context, ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(ctx).inflate(R.layout.row_epackage, viewGroup, false);
