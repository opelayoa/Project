...
// KEEP INCLUDES END
/**
 * Entity mapped to table "ORDER_PICKING".
 */
public class OrderPicking extends EqualsBase  {
    ...
    private transient OrderPickingDao myDao;
    ...
    public OrderPicking(Long id) {
        this.id = id;
    }

    public OrderPicking(Long id, Integer status, Integer type, String date, long regionId, long storeId, int paybill) {
        this.id = id;
        this.status = status;
        this.type = type;
        this.date = date;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getOrderPickingDao() : null;
    }
    ...
    public List<OrderDetail> getDetails() {
        if (details == null) {
            ...
            List<OrderDetail> detailsNew = targetDao._queryOrderPicking_Details(id);
            synchronized (this) {
                if(details == null) {
                    details = detailsNew;
                }
