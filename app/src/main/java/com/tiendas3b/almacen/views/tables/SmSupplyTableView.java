 ...
 */
public class SmSupplyTableView extends SortableTableView<SmDetailDTO> {

    public SmSupplyTableView(Context context) {
        this(context, null);
    }

    public SmSupplyTableView(Context context, AttributeSet attributes) {
        this(context, attributes, 0);
    }

    public SmSupplyTableView(Context context, AttributeSet attributes, int styleAttributes) {
        super(context, attributes, styleAttributes);

        CenterTableHeaderAdapter simpleTableHeaderAdapter = null;
        try {
            String line = new String("Linea".getBytes(), "UTF-8");
            simpleTableHeaderAdapter = new CenterTableHeaderAdapter(context,
                    "Tda", "Cve", "Cant", "Cto", "Vta", "CB", "Desc", "Proveedor", "Grupo", line, "Tipo", "Estado");
