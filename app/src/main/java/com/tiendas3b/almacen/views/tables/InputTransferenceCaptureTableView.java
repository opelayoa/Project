 ...
 */
public class InputTransferenceCaptureTableView extends TableView<InputTransferenceArticleVO> {

    private static final int TEXT_SIZE = 16;

    public InputTransferenceCaptureTableView(Context context) {
        this(context, null);
    }

    public InputTransferenceCaptureTableView(Context context, AttributeSet attributes) {
        this(context, attributes, 0);
    }

    public InputTransferenceCaptureTableView(Context context, AttributeSet attributes, int styleAttributes) {
        super(context, attributes, styleAttributes);

        CustomTableHeaderAdapter simpleTableHeaderAdapter = new CustomTableHeaderAdapter(context,
                "Clave", "Desc."
                , "Cant", "Stock", "ME", "Regreso", "Tipo", "Obs", "Obs Log");
